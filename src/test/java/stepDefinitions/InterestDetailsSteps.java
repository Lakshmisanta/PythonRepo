...
import PageMethods.InterestDetailsPage;
...
public class InterestDetailsSteps extends commonMethods {
	...
	InterestDetailsPage objinterestdetailsPage;
  SoftAssert softAssert;

	@Before
	public void setUp() {
		objinterestdetailsPage = new InterestDetailsSteps(commonMethods.driver);
	...
	public void i_choose_to_edit_contact_details() {
	  objinterestdetailsPage.edit_details();
	}

	@Then("contact details page is displayed")
	public void contact_details_page_is_displayed() {
		softAssert.assertEquals(objinterestdetailsPage.is_ContactDetails_Displayed(),true,
																"Basic details page is not displayed");
	}
