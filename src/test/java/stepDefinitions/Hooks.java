...
public class Hooks {
	 ...
	 * 
	 * System.out.println("---------------------------------------------");
	 * objCommonMethods= new commonMethods(); objCommonMethods.launchBrowser();
	 * 
	 * }
	 * 
	 * 
	 ...
	 * scenario.attach(screenshot, "image/png", scenario.getName()); // stick it in
	 * the report } objCommonMethods.closebrowser(); }
	 */
}